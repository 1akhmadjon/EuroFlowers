...
def set_sales_prompt(apps, schema_editor):
    ...
    for row in AISettings.objects.all():
        ...
        row.save(update_fields=["system_prompt", "reasoning_effort"])
    if not AISettings.objects.exists():
        AISettings.objects.create(system_prompt=SALES_PROMPT, reasoning_effort="medium")


class Migration(migrations.Migration):
    dependencies = [
        ("core", "0075_ai_prompt_objection_separation"),
    ]
