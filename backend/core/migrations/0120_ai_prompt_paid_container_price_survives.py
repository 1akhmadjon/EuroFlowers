...
Bu yakuniy jumla boshqa aytilishi SHART bo'lgan narsani yutib yubormasin.
Mijoz shu xabarda pulli idish rangini tanlagan bo'lsa, 7A dagi narx qatorini avval
yoz, keyin yakuniy jumlani qo'y.
...
Mijoz rangni ism va telefon bilan birga aytgan bo'lsa ham shu qator yoziladi.
Lead yaratganingdan keyingi yakuniy jumla bu qatorni almashtirmaydi, ikkalasi ham bo'ladi.
To'g'ri:
Qizil bo'ladi, u 100 000 so'm.
Operatorlarimiz siz bilan bog'lanib, aniq narxini aytishadi.
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0119_ai_prompt_operator_scope_and_contact_block"),
    ]
