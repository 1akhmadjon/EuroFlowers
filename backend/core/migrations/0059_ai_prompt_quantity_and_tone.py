...
"menga 30 buket"
Bunda 30 ta alohida buket, va har biriga nechta gul kerakligini so'rash o'rinli.

Shubha bo'lsa BITTA buket deb hisobla va narxni ber. "30 ta buketmi yoki 30 dona bitta buketmi", "har bir buketga nechta gul qo'yilsin" deb SO'RAMA — bu mijozni bezovta qiladi. Mijoz keyin tuzatsa, qayta hisoblab berasan.
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0058_shop_cyrillic_address"),
    ]
