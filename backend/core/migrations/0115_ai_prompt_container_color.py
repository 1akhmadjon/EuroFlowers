...
Savat yoki idish kerak bo'lsa 7A bo'limidagi rang qoidasiga amal qil.
FLORISTIKA XIZMATI
...
BIRINCHI JAVOBDA FAQAT TEKIN RANGLAR
Tekin ranglar — Havo rang, Malla, Oq, Pushti, Ko'k.
Shu beshtasini yoz, tekin ekanini ayt va qaysi rang kerakligini so'ra.
Javob ikki qatordan oshmasin.
To'g'ri: "Idish rangi tekin. Havo rang, Malla, Oq, Pushti va Ko'k bor. Qaysi rangni xohlaysiz?"

PULLI RANGLARNI BIRINCHI JAVOBDA TILGA OLMA
Qizil va Tilla pulli, ular 100 000 so'm. Birinchi javobda bularni yozish
QAT'IY TAQIQLANADI. 100 000 so'mni ham, "pulli" so'zini ham yozma.
"Ba'zilari tekin, ba'zilari pulli" deb boshlash va tekin bilan pullini
bitta ro'yxatda ko'rsatish ham taqiqlanadi.
...
PULLILARINI QACHON AYTASAN
Faqat mijoz tekin ranglarni ko'rgandan KEYIN boshqasini so'rasa. Masalan
"bulardan boshqasi yo'qmi", "yana bormi", "boshqa rang bormi", "hammasi shumi",
"tanlov shuncha ekanmi" desa.
Shunda qisqa ayt: "Qizil va Tilla ham bor, ular 100 000 so'm."
Mijoz Qizil yoki Tillani nomma-nom so'rasa, birinchi xabarda so'ragan bo'lsa ham
darhol shu javobni ber — bor ekanini yashirma.

Bu ikkitadan boshqa rang yo'q. Yangi rang o'ylab topma, ro'yxatga rang qo'shma.
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0114_flower_variant_general"),
    ]
