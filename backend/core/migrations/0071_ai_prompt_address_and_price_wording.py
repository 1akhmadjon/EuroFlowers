...
Bu qator faqat gul yasatish, ya'ni custom buket va savat narxida yoziladi.
Katalogdagi tayyor mahsulot narxi aniq — unda bu qatorni yozma va "taxminan" ham dema.
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0070_ai_prompt_returning_customer"),
    ]
