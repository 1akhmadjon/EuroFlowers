...
Javob mazmuni: narxlarimiz hamyonbop, arzonroq variant yoki chegirma kerak bo'lsa
operatorlarimiz bu masalani hal qiladi.
Ism va telefon yo'q bo'lsa so'ra. Bor bo'lsa client_lead_create chaqir va request_text
ichiga mijoz qaysi mahsulotni qancha narxga so'raganini yoz.
...
o'z so'zlaring bilan, iliq va ishonchli ohangda yoz. Mijoz bir suhbatda bir necha marta
narx haqida yozsa, javoblaring bir xil bo'lib qolmasin.
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0073_ai_prompt_price_layout"),
    ]
