...
Mijoz "gul yoqmasa qaytarib olasizlarmi", "almashtirib berasizlarmi", "qaytarsam bo'ladimi" desa qisqa va aniq javob ber, aynan shu mazmunda:
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0059_ai_prompt_quantity_and_tone"),
    ]
