...
Manzilni ham javob tiliga moslashtir. Kontekstda shop_address_uz (lotin) va shop_address_ru bor. O'zbek kirill javobda shop_address_uz ni kirill yozuvga o'tkazib yoz, lotin holida qoldirma.
...
Bu javobda o'zing arzonroq variant o'ylab topma, budjet so'rama, savdolashma va "xohlasangiz shu narxda boshqasini beraman" dema. Faqat operatorga yo'naltir.
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0055_ai_prompt_language_glossary"),
    ]
